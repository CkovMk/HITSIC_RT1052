...
int LPUART_RTOS_Init(lpuart_rtos_handle_t *handle, lpuart_handle_t *t_handle, const lpuart_rtos_config_t *cfg)
{
    ...
    LPUART_TransferCreateHandle(handle->base, (lpuart_handle_t*)handle->t_state, LPUART_RTOS_Callback, handle);
    LPUART_TransferStartRingBuffer(handle->base, (lpuart_handle_t*)handle->t_state, cfg->buffer, cfg->buffer_size);
...
int LPUART_RTOS_Send(lpuart_rtos_handle_t *handle, const uint8_t *buffer, uint32_t length)
{
    ...
    /* Non-blocking call */
    LPUART_TransferSendNonBlocking(handle->base, (lpuart_handle_t*)handle->t_state, &handle->txTransfer);
...
int LPUART_RTOS_Receive(lpuart_rtos_handle_t *handle, uint8_t *buffer, uint32_t length, size_t *received)
{
    ...
    /* Non-blocking call */
    LPUART_TransferReceiveNonBlocking(handle->base, (lpuart_handle_t*)handle->t_state, &handle->rxTransfer, &n);
    ...
    if (ev & RTOS_LPUART_HARDWARE_BUFFER_OVERRUN)
    {
        ...
        LPUART_TransferAbortReceive(handle->base, (lpuart_handle_t*)handle->t_state);
